...
public class SocialWorkspaceServiceBusinessDelegate implements Serializable {
    ...
    /**
     * Acquires a new {@link SocialWorkspaceService} reference. The related service may be deployed on a local or remote
     * AppServer.
     *
    ...
    public SocialWorkspaceService getService() throws ClientException {
        if (socialWorkspaceService == null) {
            try {
                ...
                final String errMsg = "Error connecting to SocialWorkspaceService. " + e.getMessage();
