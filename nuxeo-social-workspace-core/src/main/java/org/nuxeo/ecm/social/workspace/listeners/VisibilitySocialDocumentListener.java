...
/**
 * Class to handle "Social Document" publication after creation or update. It publishes documents in sections define
 * within "social-workspace-content-template-core.xml"
 *
...
public class VisibilitySocialDocumentListener implements EventListener {
    ...
    public void handleEvent(Event event) throws ClientException {
        ...
        if (!DOCUMENT_CREATED.equals(eventName) && !DOCUMENT_UPDATED.equals(eventName)) {
            return;
        }
        ...
        SocialWorkspace socialWorkspace = getSocialWorkspaceService().getDetachedSocialWorkspace(document);
        ...
        updateSocialDocumentVisibility(document, isPublic == null ? false : isPublic);
    }
