...
import org.nuxeo.ecm.social.workspace.adapters.SocialWorkspace;import org.nuxeo.ecm.social.workspace.service.SocialWorkspaceService;import org.nuxeo.runtime.api.Framework;

/**
 * Business delegate exposing the {@link SocialWorkspaceService} as a seam component.
 *
...
public class SocialWorkspaceServiceBusinessDelegate implements Serializable {
    ...
    /**
     * Acquires a new {@link SocialWorkspaceService} reference. The related service may
    ...
    public SocialWorkspaceService getService() throws ClientException {
        if (socialWorkspaceService == null) {
            ...
            if (socialWorkspaceService == null) {
                throw new ClientException("SocialWorkspaceService service not bound");
            }
        }
